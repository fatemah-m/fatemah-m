...
- Using Navier-Stokes and Starling equations to generate metastasis probability maps
- Goal: help clinicians identify Stage 1 tumors with elevated escalation risk
- Initial focus: breast cancer

**LA Transit Optimization** `in progress`
- Modeling a mathematically optimized Southern California transit network
...
**[Job Application Automation](https://github.com/fatemah-m/job-applier)**
...
`Python` `R` `C++` `Java` `LaTeX` `LLM Integration` `Data Modeling` `Algorithm Analysis`
...
*Seeking technical internships in software engineering, ML, automation, or data engineering. Based in Los Angeles. Open to hybrid and remote.*
